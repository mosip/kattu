...
import type { createTokenAuth, Types as TokenAuthTypes } from "@octokit/auth-token";
...
export type StrategyOptions = (OctokitStrategyOptions & {
    token: string;
}) | (OctokitStrategyOptions & AppAuth.StrategyOptions);
export type AuthOptions = TokenAuthTypes["AuthOptions"] | AppAuth.InstallationAuthOptions | {
    type: "event-octokit";
    event: {
        id: string;
        name: string;
